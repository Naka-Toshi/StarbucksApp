...
public class MenuEspressoViewAdapter extends RecyclerView.Adapter<MenuEspressoViewAdapter.ViewHolder> {

    private List<Product> productList;
    Activity activity;

    public MenuEspressoViewAdapter(List<Product> products, Activity activity) {
